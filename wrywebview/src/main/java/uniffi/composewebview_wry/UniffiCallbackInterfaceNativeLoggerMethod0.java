...
public final class UniffiCallbackInterfaceNativeLoggerMethod0 {
    ...
    @FunctionalInterface
    public interface Fn {
        void callback(long uniffiHandle,java.lang.foreign.MemorySegment data,java.lang.foreign.MemorySegment uniffiOutReturn,
